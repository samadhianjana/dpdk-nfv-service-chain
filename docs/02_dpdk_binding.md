...
We will install DPDK v21.11 (LTS) or later on both the Traffic Generator (`dpdk-1`) and the Forwarder (`dpdk-2`).

### A. Download Source Code

```bash
cd ~
wget http://fast.dpdk.org/rel/dpdk-21.11.tar.xz  # Or your specific version
